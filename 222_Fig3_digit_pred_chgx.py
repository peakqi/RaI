...
for i in range(BATCH_SIZE):
    ...
    train_x[i, :] = affine_transform_rand_x(np.reshape(train_x[i], [1, 784]))  # rtt
...
for i in range(BATCH_SIZE):
    ...
    train2_x[i, :]= affine_transform_rand_x(np.reshape(train2_x[i], [1, 784]))  # rtt

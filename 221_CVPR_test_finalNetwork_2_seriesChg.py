...
#          XX       YY      SX      SY      RX
para1[:,0]=[0,       0,      .65,    .65,    0]
para1[:,1]=[0.4,     0,      .65,    .65,    0]
para1[:,2]=[-0.1,    0,      .65,    .65,    0]
para1[:,3]=[0,       0.1,    .65,    .65,    0]
para1[:,4]=[0,       0,      .80,    .65,    0]
para1[:,5]=[0,       0,      1.0,    .65,    0]
para1[:,6]=[0,       0,      .80,    .80,    0]
para1[:,7]=[0,       0,      .65,    .65,    0.1]
para1[:,8]=[0,       0,      .65,    .65,    0.2]
para1[:,9]=[0.1,     0.1,    .80,    .80,    0.1]

...
view_x, b_y = mnist.train.next_batch(BATCH_SIZE)
...
mat=aaaa.transpose();
mtd='ward' #'ward',’average’
Z = linkage(mat, mtd)
dict=dendrogram(Z,    leaf_rotation=90., )# leaf_font_size=8.,
ind_ffenc=dict['leaves']
plt.show()
plt.title('./Dendro/ff_enc.classify')
plt.savefig('./Dendro/ff_enc.classify.png')
...
# plt.close('all')
# plt.figure(figsize=(25, 10))
# dict=dendrogram(Z,    leaf_rotation=90., orientation='left'  )
# ind_en3=dict['leaves']
# plt.show()
# plt.title('./Dendro/en3.classify')
# plt.savefig('./Dendro/en3.classify.png')
# aaa=1
#
#
#
...
#
# saver.restore(sess, '/Users/fengqi/Pycharm_py36/QF/4900000/' + type)
# view_decoded_data, we0_49, we1, we2, we3_49, wem_49, wd0, wd1, wd2, wd3, wdd, en0_, en1_, en2_, en3_, ff_encoded_, de0_, de1_, de2_, de3_, ddr_ = sess.run(
#     [decoded, weights_en0, weights_en1, weights_en2, weights_en3, weights_mid,
#      weights_de0, weights_de1, weights_de2, weights_de3, weights_ddr, en0, en1, en2, en3, ff_encoded, de0, de1,
#      de2, de3, decoded],
#     {tf_x: view_x,
...
# view_decoded_data, we0_new, we1, we2, we3_new, wem_new, wd0, wd1, wd2, wd3, wdd, en0_, en1_, en2_, en3_, ff_encoded_, de0_, de1_, de2_, de3_, ddr_ = sess.run(
#     [decoded, weights_en0, weights_en1, weights_en2, weights_en3, weights_mid,
#      weights_de0, weights_de1, weights_de2, weights_de3, weights_ddr, en0, en1, en2, en3, ff_encoded, de0, de1,
#      de2, de3, decoded],
#     {tf_x: view_x,
...
# view_decoded_data, we0_old, we1, we2, we3, wem_old, wd0, wd1, wd2, wd3, wdd, en0_, en1_, en2_, en3_, ff_encoded_, de0_, de1_, de2_, de3_, ddr_ = sess.run(
#     [decoded, weights_en0, weights_en1, weights_en2, weights_en3, weights_mid,
#      weights_de0, weights_de1, weights_de2, weights_de3, weights_ddr, en0, en1, en2, en3, ff_encoded, de0, de1,
#      de2, de3, decoded],
#     {tf_x: view_x,

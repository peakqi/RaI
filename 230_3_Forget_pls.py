...
saver.restore(sess, '/Users/fengqi/Pycharm_py36/QF/LnNew_Forgetting/'+str(initstep)+'/' + type)
...
for jj in range(10000,20001):
    ...
    if jj % 1==0:
        ...
        if jj==10000  or jj==11000 or jj==12000  or jj==13000 or jj==14000 or jj==16000 or jj==17000 or jj==18000 or jj==19000  or jj==20000:
            xrange = np.arange(kk)
            plt.cla()
            plt.scatter(xrange, Lx, Lx * 0 + 0.5, c="b")
            plt.scatter(xrange, Ld, Ld * 0 + 0.5, c="r")
            plt.savefig('LnNew_Forgetting/loss_forget'+str(jj)+'.png')
            np.save('LnNew_Forgetting/loss_forget_Lx' + str(jj), Lx)
            np.save('LnNew_Forgetting/loss_forget_Ld' + str(jj), Ld)

            checkstr = '/Users/fengqi/Pycharm_py36/QF/LnNew_Forgetting/Forgeting' + str(jj) + '/' + '_n_' + str(n_encoded) + '-batch' + str(
